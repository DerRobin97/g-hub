/* Line-icon set — stroke 1.8, currentColor. <Icon name="home" size={22} /> */
const ICON_PATHS = {
  ...
  campaign:  '<path d="M4 9v6l9 4V5L4 9z"/><path d="M4 9H3a1 1 0 0 0-1 1v4a1 1 0 0 0 1 1h1"/><path d="M16 8a5 5 0 0 1 0 8M18.5 5.5a9 9 0 0 1 0 13"/>',
  chart:     '<path d="M4 20V4"/><path d="M4 20h16"/><rect x="7" y="11" width="3" height="6" rx="1"/><rect x="12.5" y="7" width="3" height="10" rx="1"/><rect x="18" y="13" width="0.5" height="4"/><path d="M7 9.5 11 6l3 2 5-4.5"/>',
  ...
  users:     '<circle cx="9" cy="8" r="3.2"/><path d="M3.5 19a5.5 5.5 0 0 1 11 0"/><path d="M16 5.5a3 3 0 0 1 0 5.8M17 19a5.5 5.5 0 0 0-2.5-4.4"/>',
  ...
  image:     '<rect x="3" y="4.5" width="18" height="15" rx="3"/><circle cx="8.5" cy="9.5" r="1.8"/><path d="m3.5 17 5-4.5 4 3.5 3-2.5 5 4"/>',
  video:     '<rect x="2.5" y="5.5" width="14" height="13" rx="3"/><path d="m16.5 10 5-3v10l-5-3z"/>',
  file:      '<path d="M6 3h7l5 5v13H6z"/><path d="M13 3v5h5"/>',
  sparkle:   '<path d="M12 3v5M12 16v5M3 12h5M16 12h5"/><path d="M12 8.5 13.6 11 16 12l-2.4 1L12 15.5 10.4 13 8 12l2.4-1L12 8.5z"/>',
  ...
  pause:     '<rect x="7" y="6" width="3.2" height="12" rx="1" fill="currentColor" stroke="none"/><rect x="13.8" y="6" width="3.2" height="12" rx="1" fill="currentColor" stroke="none"/>',
  stop:      '<rect x="6.5" y="6.5" width="11" height="11" rx="2.5" fill="currentColor" stroke="none"/>',
  coffee:    '<path d="M4 8h13v5a5 5 0 0 1-5 5H9a5 5 0 0 1-5-5z"/><path d="M17 9h2.4a2.1 2.1 0 0 1 0 4.2H17"/><path d="M8 2.5c-.6.8-.6 1.7 0 2.5M12 2.5c-.6.8-.6 1.7 0 2.5"/>',
  ...
  phone:     '<path d="M5 4h3.2l1.4 4.2-2 1.4a11.5 11.5 0 0 0 5.4 5.4l1.4-2 4.2 1.4V18a2 2 0 0 1-2.2 2A15.5 15.5 0 0 1 3 6.2 2 2 0 0 1 5 4z"/>',
